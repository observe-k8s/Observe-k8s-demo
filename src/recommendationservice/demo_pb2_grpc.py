...
resource=Resource.create({"service.name": "Recomendation demo__pb2-server"})
...
class CartServiceServicer(object):
  ...
  def AddItem(self, request, context):
    with tracer.start_as_current_span("cart service AddItem"):
  ...
  def GetCart(self, request, context):
    with tracer.start_as_current_span("cart service GetCart"):
        # missing associated documentation comment in .proto file
        pass
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
  ...
  def EmptyCart(self, request, context):
    with tracer.start_as_current_span("cart service EmptyCart"):
        # missing associated documentation comment in .proto file
        pass
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
class RecommendationServiceServicer(object):
  ...
  def ListRecommendations(self, request, context):
    with tracer.start_as_current_span("RecommendationServiceServicer ListRecommendations"):
        # missing associated documentation comment in .proto file
        pass
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_RecommendationServiceServicer_to_server(servicer, server):
  with tracer.start_as_current_span("RecommendationServiceServicer add_RecommendationServiceServicer_to_server"):
      rpc_method_handlers = {
